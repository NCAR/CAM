...
Eaton, B. E. 2010. *User’s Guide to the Community Atmosphere Model AM4.0*. Boulder, Colorado: National Center for Atmospheric Research.
...
Cloud Ensemble with the Large-Scale Environment. Part IV: The Discrete Model.” *J. Atmos. Sci.* 39: 104–13.
...
Washington, W. M. 1982. *Documentation for the Community Climate Model (CCM), Version* :math:`\emptyset`. 
NTIS No. PB82 194192. Boulder, Colorado: National Center for Atmospheric Research.
...
Wiscombe:Xu, K.-M., and S. K. Krueger. 1991. “Evaluation of Cloudiness
