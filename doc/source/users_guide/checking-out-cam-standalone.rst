...
should only be done by users to run E, F, Q, or P compsets.  Also for scientific studies, it
...
If you wish to use other compsets you will need to download the entire CESM model.  Please use the directions for `downloading CESM <http://escomp.github.io/cesm/release-cesm2/downloading_cesm.html>`_ and you should ignore the rest of this chapter.  
...
At this point you will see you have two files: README.md  CODE_OF_CONDUCT.md
...
If a user wishes to get the most recent CAM development code, they can checkout the head of the cam_development branch.  Please note that this code is the most recent committed code and while basic testing has occurred, its use for scientific studies is not recommended.
...
The `wiki page for CAM development http://escomp.github.io/CAM/wiki>`_ contains more detailed information. 
